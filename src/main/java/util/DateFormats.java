...
public class DateFormats {
    ...
    public static String formatD(Object date) {
        return getSdf(DATE_PATTERN).format(date);
    }
    ...
    public static String timestamp2String(long unixTimestamp) {
        SimpleDateFormat format = getSdf(DATETIME_PATTERN);
        String d = format.format(unixTimestamp);
        return d;
    }
