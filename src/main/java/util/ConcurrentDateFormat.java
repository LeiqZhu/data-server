...
public class ConcurrentDateFormat extends DateFormat {
     ...
     * date format symbols for the default locale, and the parsing is not
     * lenient as default. Note: This constructor may not support all locales.
     * For full coverage, use the factory methods in the {@link DateFormats}
     * class.
     * 
     * @param pattern
    ...
    public synchronized boolean equals(Object obj) {
        if (obj instanceof ConcurrentDateFormat)
            return format.equals(((ConcurrentDateFormat) obj).format);
