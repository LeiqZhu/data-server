...
public class NettyConfig {
    ...
    public int ioBossNum = 2;
    public int ioWorkerNum = 20;

    public int ioThreadCoreNum = 10;
    public int ioThreadMaxNum = 20;
    public int maxWorkerInQueue = 30;
    ...
    public int blockTimeout = 10000;
    public int poolLogSpan = 0;
    ...
    // 是否启用AdEx本地缓存数据, 默认为false
    public boolean isUseLocalDataCache = false;
    ...
    public NettyConfig(String fileName) {
     ...
     String filePath = System.getProperty("user.dir") + "/netty.properties";
    ...
    public NettyConfig initConfig(NutJsonConfig pc) {
        ...
        this.ioThreadCoreNum = pc.getInt("netty.ioThreadCoreNum", this.ioThreadCoreNum);
        this.ioThreadMaxNum = pc.getInt("netty.ioThreadMaxNum", this.ioThreadMaxNum);
        this.maxWorkerInQueue = pc.getInt("netty.maxWorkerInQueue", this.maxWorkerInQueue);
        ...
        this.blockTimeout = 2 * this.soTimeout;
        this.blockTimeout = pc.getInt("netty.blockTimeout", this.blockTimeout);

        this.poolLogSpan = pc.getInt("netty.poolLogSpan", this.poolLogSpan);
        ...
        this.default404Info = pc.getString("netty.404info", this.default404Info);
         ...
         this.isUseLocalDataCache = pc.getBoolean("netty.is_use_local_data_cache",
                                                 this.isUseLocalDataCache);
